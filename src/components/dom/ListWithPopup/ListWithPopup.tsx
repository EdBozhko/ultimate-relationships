...
export const ListWithPopup: ListWithPopupComponent = memo(
  ({ popupButtons = [], list = [], itemsPerRow = 2, itemsOrientation = 'vert' }) => {
    ...
    const [paddingBottom, setPaddingBottom] = useState('50vh');
      ...
      <>
        ...
        <AnimatedPopup
          ...
          style={{
            ...
            paddingBottom: `calc(${paddingBottom} + 7rem)`,
            y,
          }}
        >
